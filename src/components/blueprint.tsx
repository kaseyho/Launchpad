...
export function BlueprintView({ workspace, traceNodes, onTrace, onExport }: BlueprintViewProps) {
  ...
  return (
    <section className="blueprint-view" aria-label="Proof-Carrying Idea Blueprint">
      <header className="blueprint-header"><div><span>Final recommendation · blueprint v{blueprint.version}</span><h1>{blueprint.name}</h1><p>{blueprint.proposition}</p></div><div className="blueprint-stamp">PROOF<br />CARRYING</div></header>
